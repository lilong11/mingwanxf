        ...
        @foreach($info as $v)
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value=" @if($v->contract_number) {{$v->contract_number}}@endif" id="contract" name="contract" required="" autocomplete="off" class="layui-input" lay-verify="required">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="@if($v->project_address) {{$v->project_address}}@endif" id="address" name="address" required="" autocomplete="off"  class="layui-input" lay-verify="required">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="@if($v->project_name) {{$v->project_name}}@endif" id="name" name="name" required="" autocomplete="off"  class="layui-input" lay-verify="required">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="decoration_status" value="-1" id="modify_status" title="待开工" @if($v->decoration_status==-1) checked @elseif($v->decoration_status == null) checked  @endif>
            ...
            <div class="layui-input-inline">
                <select name="designer">
                    @if($v->designer_id != null)
                        <option value="{{$v->designer_id}}">{{$v->isDesigner}}</option>
                    @else
                        <option value="">请选择设计师</option>
                    @endif
                    @foreach($v->designer as $vv)
            ...
            <div class="layui-input-inline">
                <select name="manager">
                    @if($v->manager_id != null)
                        <option value="{{$v->manager_id}}">{{$v->isManager}}</option>
                    @else
                        <option value="">请选择项目经理</option>
                    @endif
                    @foreach($v->manager as  $mm)
            ...
            <div class="layui-input-inline">
                <select name="supervisor">
                    @if($v->supervision_id != null)
                        <option value="{{$v->supervision_id}}">{{$v->isSupervisor}}</option>
                    @else
                        <option value="">请选择监理</option>
                    @endif
                    @foreach($v->supervisor as $ss)
