...
<div class="x-body">
    <div class="layui-row">
            <form class="layui-form" action="{{'/projectEdit'}}/{{$list->id}}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="troa" value="1" id="troa" title="施工中" @if($list->troa==1) checked @endif>
                    <input type="radio" name="troa" value="2" id="troa" title="通过" @if($list->troa==2) checked @endif>
                    <input type="radio" name="troa" value="3" id="troa" title="不通过" @if($list->troa==3) checked @endif>
                </div>
            </div>
            <div class="layui-form-item">
                <label for="L_username" class="layui-form-label">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="contract_status" value="1" id="contract_status" title="待开工" @if($list->contract_status==1) checked @endif>
                    <input type="radio" name="contract_status" value="2" id="contract_status" title="在建工地" @if($list->contract_status==2) checked @endif >
                    <input type="radio" name="contract_status" value="3" id="contract_status" title="竣工" @if($list->contract_status==3) checked @endif>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline layui-show-xs-block">
                    <input class="layui-input" value="{{$list->start_time}}" placeholder="开工日期" name="start_time" id="start_time">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline layui-show-xs-block">
                    <input class="layui-input" value="{{$list->end_time}}" autocomplete="off" placeholder="竣工日期" name="end_time" id="end_time">
                </div>
            </div>
