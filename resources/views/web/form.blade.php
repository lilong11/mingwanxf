...
<div class="x-body" onsubmit="false">
    <form class="layui-form" method="post" action="{{url('form')}}">
        ...
        <input type="number" style="display: none" id="approach" value="1" name="approach" required lay-verify="required" autocomplete="off" class="layui-input">
        <div class="layui-form-item">
